...
function initAnimations() {
    ...
    const animatedElements = document.querySelectorAll('.section-header, .project-card, .about-card, .skills-category, .contact-item');
...
function initTypingAnimation() {
    ...
    const textToType = 'Olá, eu sou Marco Antonio';
    const highlightText = 'Marco Antonio';
    ...
    const typeWriter = () => {
        if (i < textToType.length) {
            const currentChar = textToType.charAt(i);
